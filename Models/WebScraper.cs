...
//        //        if (league == null)
//        //        {
//        //            CountryModel? country = await uow.CountryModelRepository.GetCountryAsync(countryName);
//        //            if (country == null)
//        //            {
...
//        //            if (game.Date.Hour == 0 && game.Date.TimeOfDay != hoursAndMinutes)
//        //            {
//        //                game.Date.Add(hoursAndMinutes);
//        //                uow.GameModelRepository.UpdateGame(game);
//        //                await uow.SaveAsync();
//        //            }
...
//        //                if (value1 > value2) dbGame.WhatBetHasValue = "1";
//        //                else dbGame.WhatBetHasValue = "2";
